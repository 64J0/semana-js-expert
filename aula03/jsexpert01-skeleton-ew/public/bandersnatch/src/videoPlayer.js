class VideoMediaPlayer {
  ...
  initializeCodec() {
    ...
    mediaSource.addEventListener("sourceopen", this.sourceOpenWraper(mediaSource))
  }

  sourceOpenWraper(mediaSource) {
    return async (_) => {
  ...
  async nextChunk(data) {
    ...
    // deixa o restante do vídeo rodar enquanto o novo vídeo é baixado
