# script para tratar os videos
# gerando nas proporções de 144, 360 e 720px
# usando os codecs de audio e video aceitos
# pelos navegadores
#
# Requisitos:
# ffmpeg, ffprobe
...
for mediaFile in `ls $ASSETSFOLDER | grep .mp4`; do
  ...
  # criar pastas com o nome dos arquivos configurados
